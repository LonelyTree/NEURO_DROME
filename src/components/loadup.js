    ...
    <div className="screen">
        <div className="box--outer">
            ...
            <Exit/>
                ...
                <Title className="glitch" id="loadup" data-text="LOAD UP YOUR A.I.">LOAD UP YOUR A.I. </Title>
                <PullWrapper>
                <Pull>PULL A.I.</Pull>
                <Storage>
                    <option value='' disabled selected>COLD STORAGE</option>
                    {this.pullFromStorage()}
                </Storage>
                </PullWrapper>
                <NewWrapper>
                <New>INPUT NEW</New>
                <SoulLabel htmlFor='harvester' className='glitch' id='soulFor' data-text='ALIVE'>SOUL</SoulLabel>
